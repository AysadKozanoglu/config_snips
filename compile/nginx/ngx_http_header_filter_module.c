 ...
 * Custom Changes by: Aysad Kozanoglu
 */
...
static u_char ngx_http_server_string[] = "Server: GhostServerV1.0" CRLF;
static u_char ngx_http_server_full_string[] = "Server: GhostServerV1.0" CRLF;
